	...
	Jmol._jsSetPrototype = function(proto) {
      ...
      Jmol._jsSetMouse(canvas);
		...
		proto._setupJS = function(id, Info) {
			...
			es.push([this, this.__loadClazz, null, "loadClazz"])
			if (!this._is2D) {
	   		es.push([this, this.__loadClass, "org.jmol.exportjs.JSExporter","load JSExporter"])
				es.push([this, this.__addExportHook, null, "addExportHook"])
			}			 			
			if (Jmol.debugCode) {
        //es.push([this.__checkLoadStatus, null,"checkLoadStatus"])
        es.push([this, this.__loadClass, "org.jmol.appletjs.Jmol", "load Jmol"])
      }
