...
Clazz.load (["org.jmol.adapter.smarter.AtomSetCollectionReader", "java.util.Hashtable"], "org.jmol.adapter.readers.xml.XmlReader", ["org.jmol.adapter.smarter.AtomSetCollection", "$.Resolver", "org.jmol.api.Interface", "org.jmol.util.Logger"], function () {
...
try {
thisReader.processXml (this, this.atomSetCollection, this.reader, saxReader);
} catch (e) {
if (Clazz.exceptionOf (e, Exception)) {
...
function (parent, atomSetCollection, reader, saxReader) {
this.parent = parent;
this.atomSetCollection = atomSetCollection;
this.reader = reader;
if (saxReader == null) {
this.domObj = parent.domObj;
...
}}, "org.jmol.adapter.readers.xml.XmlReader,org.jmol.adapter.smarter.AtomSetCollection,java.io.BufferedReader,~O");
