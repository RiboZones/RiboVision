...
Clazz.load (["JU.P3"], "J.adapter.smarter.XtalSymmetry", ["java.lang.Boolean", "$.Float", "java.util.Hashtable", "JU.BS", "$.M3", "$.M4", "$.P3i", "$.PT", "$.SB", "$.V3", "J.adapter.smarter.Atom", "J.api.Interface", "JU.BSUtil", "$.Escape", "$.Logger"], function () {
...
function (pt) {
this.ptSupercell = pt;
JU.Logger.info ("Using supercell " + JU.Escape.eP (pt));
}, "JU.P3");
...
var timeRev = symmetry.getSpaceGroupOperationTimeRev (iSym);
