...
this.screenVectorEnd.setT (this.tm.transformPtVib (this.pointVectorEnd, vib, this.vectorScale));
this.pointArrowHead.add2 (this.pointVectorEnd, this.headOffsetVector);
this.screenArrowHead.setT (this.tm.transformPtVib (this.pointArrowHead, vib, this.vectorScale));
